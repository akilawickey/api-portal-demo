...
import assesment.apiportal.publisher.demo.config.services.UserDetailsImpl;
import assesment.apiportal.publisher.demo.controller.dto.JwtResponceDTO;
import assesment.apiportal.publisher.demo.controller.dto.LoginDTO;
import assesment.apiportal.publisher.demo.controller.dto.MessageResponceDTO;
import assesment.apiportal.publisher.demo.controller.dto.SignupDTO;
    ...
    public ResponseEntity<?> registerUser(@RequestBody SignupDTO signupDTO) {
        if (userRepository.existsByUsername(signupDTO.getUsername())) {
            return ResponseEntity
                    .badRequest()
                    .body(new MessageResponceDTO("Error: Username is already taken!"));
        }

        if (userRepository.existsByEmail(signupDTO.getEmail())) {
            return ResponseEntity
                    .badRequest()
                    .body(new MessageResponceDTO("Error: Email is already in use!"));
        }
        ...
        return ResponseEntity.ok(new MessageResponceDTO("User registered successfully!"));
    }
}
